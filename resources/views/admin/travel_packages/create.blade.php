                    ...
                    <div class="card p-3">
                        <form method="post" action="{{ route('admin.travel_packages.store') }}">
                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="type" value="{{ old('type') }}" id="type" placeholder="contoh: 2 Hari 1 Malam">
                                </div>
                            </div>
                            <div class="form-group row border-bottom pb-4">
                                <label for="Location" class="col-sm-2 col-form-label">Nama Paket</label>
                                <div class="col-sm-10">
                                <input text="text" class="form-control" id="Location" name="location" value="{{ old('location') }}" placeholder="contoh : Longivilia Bromo">
                                </div>
                            </div>
                            <div class="form-group row border-bottom pb-4">
